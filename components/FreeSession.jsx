...
const FreeSession = () => {
  return (
    <section className="min-h-screen bg-cover bg-primary mt-5 contactBg relative z-10 ">
          ...
          <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
            <div className="text-white lg:w-1/2 lg:mx-6">
              <h1 className="text-3xl font-semibold capitalize lg:text-5xl">
                Ultimate <span className="text-secondary">Design Solution</span>
              </h1>

              <p className="max-w-xl mt-6">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatem quo aliquid molestiae hic incidunt beatae placeat accusantium!
                Alias ex quisquam ab tempora. Ratione autem doloremque ducimus numquam doloribus, error sed.
              </p>
