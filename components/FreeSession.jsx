        ...
        <div className="container flex flex-col flex-1 p-6 mx-auto">
          <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
            ...
            <div className="text-white lg:w-1/2 lg:mx-6">
              ...
              <p className="max-w-xl mt-6">Ready to build your brand? You are just one step away to experience the progress.</p>
              <p className="max-w-xl mt-6">If there is still something you want to know, get in touch with us!</p>

              <Button title="Get in touch" />

              <div className="mt-6 md:mt-8 ">
                <h3 className="text-gray-300 text-2xl font-semibold">Follow us</h3>
            ...
            <div className="mt-8">
              <h1 className="text-2xl font-medium rounded-t text-white px-5 py-4 text-center bg-secondary ">Get A Free 30-Minute Strategy Session</h1>
              <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl  dark:bg-gray-800 lg:max-w-xl rounded-b">
                <form action="https://formbold.com/s/FORM_ID" method="POST">
                  <div className="-mx-3 flex flex-wrap">
                    <div className="w-full px-3 sm:w-1/2">
                      <div className="mb-5">
                        <label htmlFor="fName" className="text-start mb-[2px] ml-[5px] block  font-medium text-white">
                          * First Name
                        </label>
                        <input
                          type="name"
                    ...
                    <div className="w-full px-3 sm:w-1/2">
                      <div className="mb-5">
                        <label htmlFor="lName" className=" text-start mb-1 ml-[5px] block  font-medium text-white">
                          * Last Name
                        </label>
                        <input
                          type="name"
                  ...
                  <div className="-mx-3 flex flex-wrap">
                    ...
                    <div className="w-full px-3 sm:w-1/2">
                      <div className="mb-5">
                        <label htmlFor="lName" className=" text-start mb-1 block ml-[5px] font-medium text-white">
                          * Phone Number
                        </label>
                        <input
                          type="number"
                  ...
                  <div className="relative mb-4">
                    <label htmlFor="me3sag3" className="text-start mb-[2px] ml-[5px] block  font-medium text-white">
                      Message
                    </label>
                    <textarea
                      id="message"
