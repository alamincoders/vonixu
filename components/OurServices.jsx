    ...
    <>
      <section className="container py-10">
        ...
        <div className="  grid md:grid-cols-2 xl:grid-cols-3 gap-10 pt-10 ">
          <div class="relative block rounded-sm border-t-4 border-pink-600 p-8 pb-24 shadow-xl">
            <h3 class="text-[20px] text-primary font-bold">Digital Marketing Agency</h3>
            ...
            <button className=" bottom-8 right-8 absolute inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-primary transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group">
