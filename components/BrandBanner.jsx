  ...
  return (
    <div className="bg-default-color py-28 text-center">
      <div className="container">
        ...
        <button className="bg-white text-default-color text-sm lg:text-xl px-8 py-3.5 border-0 rounded-lg font-medium  hover:bg-[#022f6a] hover:text-white duration-200 transition ease-in-out ">
