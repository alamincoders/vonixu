...
const ContactUs = () => {
  return (
    <div>
      ...
      {/* Get In Touch */}
      <div className="text-gray-600 bg-gray-50 mt-20 rounded-2xl container  py-10 body-font relative">
        <h1 className="text-4xl font-bold">
        ...
        <div className=" pt-14 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            <h2 className="text-gray-900 mb-1  title-font text-3xl font-semibold  ">
              Contact Us
            </h2>
