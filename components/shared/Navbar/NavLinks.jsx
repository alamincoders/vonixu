      ...
      {Links.map((link, i) => (
        <div key={i}>
          <div className="pr-4 md:pr-1 lg:pr-0 text-left md:cursor-pointer group">
            ...
            >
              <li className="text-[16px] font-medium text-primary cursor-pointer">{link.name}</li>
            ...
            {link.submenu && (
              <div>
                <div className="absolute top-20 hidden group-hover:md:block hover:md:block">
                  ...
                  <div className="bg-gray-50 border-2 shadow-lg rounded-lg p-5 grid grid-cols-3 gap-10">
